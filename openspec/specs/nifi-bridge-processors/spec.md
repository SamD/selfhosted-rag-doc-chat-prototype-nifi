# NiFi Bridge Processors

## Purpose

Provide NiFi Python processors that bridge Redis queues with NiFi's data flow, enabling transparent message routing between worker `_input` and `_output` queues with provenance tracking and backpressure management.
